    ...
    <div className="p-5 lg:p-8 space-y-6 max-w-6xl">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/invoices/new">
          <Button className="bg-[#006400] hover:bg-[#005000] text-white rounded-lg h-9 text-[13px] px-4">
      ...
      <div className="grid lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-3 grid grid-cols-2 gap-3">
          <Link to="/invoices/new" className="group bg-[#006400] rounded-xl p-5 hover:bg-[#005000] transition-colors">
            <Plus className="w-5 h-5 text-white/70 mb-8" />
            <p className="text-white font-semibold text-[14px]">Create Invoice</p>
            <ArrowRight className="w-3.5 h-3.5 text-white/40 mt-1 group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link to="/invoices" className="group bg-white rounded-xl p-5 border border-gray-100 hover:border-gray-200 transition-colors">
            <FileText className="w-5 h-5 text-gray-300 mb-8" />
            <p className="text-gray-900 font-semibold text-[14px]">View Invoices</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100">
          ...
          <div className="divide-y divide-gray-50">
            {myInvoices.slice(0, 5).map(inv => (
              <Link key={inv.id} to={`/invoices/${inv.id}`} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50/50 transition-colors">
